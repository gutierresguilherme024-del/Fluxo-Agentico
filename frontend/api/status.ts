...
async function fetchHealthWithRetry(url: string, retries = 3): Promise<Response> {
    ...
    throw lastError instanceof Error ? lastError : new Error('Falha no health check do backend.');
}
