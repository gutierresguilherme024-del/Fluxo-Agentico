...
CMD sh -c 'echo "[STARTUP] PORT injetado = $PORT" && echo "[DEBUG] Iniciando Uvicorn em $PORT" && python -m uvicorn main:app --host 0.0.0.0 --port $PORT --workers 1 --log-level info'
